...
import com.example.growmatetodo.databinding.FragmentAddNoteBinding
...
class AddNoteFragment : Fragment(R.layout.fragment_add_note), MenuProvider {
    ...
    private fun saveNote(view: View){
        ...
        if (noteTitle.isNotEmpty()){
            ...
            Toast.makeText(addNoteView.context, "Please enter the plant name", Toast.LENGTH_SHORT).show()
        }
    }
