package com.example.growmatetodo.fragments
...
import com.example.growmatetodo.databinding.FragmentEditNoteBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.editNoteFab.setOnClickListener {
            ...
            if (noteTitle.isNotEmpty()) {
                ...
                Toast.makeText(context, "Please enter the plant name", Toast.LENGTH_SHORT).show()
            }
        }
    }
    ...
    private fun deleteNote(){
        AlertDialog.Builder(activity).apply {
            ...
            setPositiveButton("Yes"){ _, _ ->
                ...
                Toast.makeText(context, "Plant deleted from the list", Toast.LENGTH_SHORT).show()
                view?.findNavController()?.popBackStack(R.id.homeFragment, false)}
